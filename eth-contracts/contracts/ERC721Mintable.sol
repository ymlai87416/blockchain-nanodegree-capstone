...
contract ERC721 is Pausable, ERC165 {
    ...
    // update link 27Apr2020: https://github.com/OpenZeppelin/openzeppelin-contracts-ethereum-package/blob/master/contracts/drafts/Counters.sol
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner,"cannot transfer tokent to owner.");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        // TODO why contract owner not token owner?
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "can only be called by token owner or approved operator");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "from address should be the owner of the given token");
        // TODO: require token is being transfered to valid address
        require(to != address(0), "'to' address should be a valid address");
...
contract TomPropertyListingERC721Token is ERC721Metadata("Tom Property Listing","TPL","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
